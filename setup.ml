...
(* OASIS_START *)
(* DO NOT EDIT (digest: 45748619e8fc1f7124c91e955b9065e1) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          bugreports = None;
          synopsis = "ppx extension for lol";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ppx_memo.ml"});
               Test
                 ({
                     cs_name = "test_ppx_protobuf";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
          ...
          install_custom =
            {
               pre_command =
                 [
                    (OASISExpr.EBool true,
                      Some
                        (("$ocamlfind", ["install"; "ppx_memo"; "lib/META"])))
                 ];
               post_command = [(OASISExpr.EBool true, None)]
            };
          uninstall_custom =
            {
               pre_command =
                 [
                    (OASISExpr.EBool true,
                      Some (("$ocamlfind", ["remove"; "ppx_memo"])))
                 ];
               post_command = [(OASISExpr.EBool true, None)]
            };
          clean_custom =
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\0231\240\173\220\012=\246\232<sN\230\239T\152";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
